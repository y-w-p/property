...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="visitor_park_delete">删除</a>
...
layui.use(['jquery', 'form', 'table', 'layer', 'tree'], function(){
  ...
  table.render({
    elem: '#test'
    ,url:'/admin/admin_visitor_park_cost' //数据接口
    ,method:'get'
    ,page: true
    ,id: 'testReload'
    ,cols: [
      ...
      ,{fixed: 'right', title:'操作', toolbar: '#barDemo'}
        ...
        //监听行工具事件
         table.on('tool(test)', function(obj){
             ...
             //结束操作
             if(obj.event === 'visitor_park_delete'){
                 layer.confirm('确定删除停车账单号为'+park_id+'的游客停车账单吗？',{btn:["确定","取消"]},
                 //确定事件
                 function () {
                     $.ajax({
                       url:"/admin/admin_delete_visitor_park",
