  ...
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right">
     ...
     <%=request.getSession().getAttribute("name")%>
        ...
        <dl class="layui-nav-child">
          <dd><a href="<c:url value="/visitor/toVisitorInfo" />" target="towhere">个人信息</a></dd>
          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" onclick="cost()">
                <i class="layui-icon">&#xe602;</i>账单详情</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
          <a href="javascript:;">
...
//JavaScript代码区域
  ...
  function Info() {
    $("#towhere").attr("src", '/visitor/toVisitorInfo');
  }
  ...
  function parking() {
    $("#towhere").attr("src", '/visitor/toVisitorParking');
  }
  function cost() {
      $("#towhere").attr("src", '/visitor/toVisitorCosting');
    }
  function platform() {
